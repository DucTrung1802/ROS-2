...
domain = linspace(0.0, 1.0, 100)  # Domain is defined as discrete space in the
...
Small = IT2FS_Gaussian_UncertStd(domain, [0, 0.15, 0.1, 1.0])
...
Medium = IT2FS_Gaussian_UncertStd(domain, [0.5, 0.15, 0.1, 1.0])
...
Large = IT2FS_Gaussian_UncertStd(domain, [1.0, 0.15, 0.1, 1.0])
